...
gg.gam5
```
There's a noticeable difference between gam models 2 and 4. It appears the residuals become smoother when adding variables. Similar to the explained variance visualization across the four multi-variable gam models, there doesn't appear to be a distinct difference between models with 4 and 5 variables. 
...
```{r visualizing-the-model, echo = F,fig.show = "hold",warning=F,out.width = "100%",fig.align="center",fig.width=10,fig.height=10}
